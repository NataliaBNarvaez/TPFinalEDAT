...
public class Prueba {
    public static void main(String[] args) {
        ...
        Estacion a = new Estacion("neuquen", "null", 0, "a", 0, 0, 0);
        Estacion b = new Estacion("neuaaa", "null", 0, "a", 0, 0, 0);
        Estacion c = new Estacion("cipoletti", "null", 0, "a", 0, 0, 0);
        Estacion d = new Estacion("roca", "null", 0, "a", 0, 0, 0);
        Estacion e = new Estacion("neuquena", "null", 0, "a", 0, 0, 0);
        Estacion f = new Estacion("aaaala", "null", 0, "a", 0, 0, 0);
        Estacion g = new Estacion("zapala", "null", 0, "a", 0, 0, 0);
        Estacion h = new Estacion("dado", "null", 0, "a", 0, 0, 0);
