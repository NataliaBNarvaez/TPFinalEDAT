...
public class prueba {
    public static void main(String[] args) {
        ...
        g.insertarArco(1, 2, 3);
        g.insertarArco(2, 4, 6);
        g.insertarArco(3, 2, 5);
        g.insertarArco(3, 5, 8);
        g.insertarArco(4, 1, 5);
        g.insertarArco(4, 5, 9);
        g.insertarArco(5, 1, 6);
        g.insertarArco(5, 2, 7);
        ...
        System.out.println("Elimino arco 6 a 4 (6 no existe): " + g.eliminarArco(6, 4));
